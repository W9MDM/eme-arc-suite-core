...
// Include the Plugin Update Checker library from eme-arc-suite if available, or local copy
$checker_path = WP_PLUGIN_DIR . '/eme-arc-suite/plugin-update-checker/plugin-update-checker.php';
...
if (file_exists($checker_path)) {
    ...
    $updateChecker = Puc_v4_Factory::buildUpdateChecker(
        'https://github.com/W9MDM/eme-arc-suite-core', // GitHub repo URL
        __FILE__, // Full path to the main plugin file
        'eme-arc-suite-core' // Plugin slug
    );
